defmodule Habitsheet.Users.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Habitsheet.Repo)
  ...
  """
  def valid_password?(%Habitsheet.Users.User{hashed_password: hashed_password}, password)
